...
<@script type="text/javascript" src="${page.url.context}/res/alfea/components/activity-stats/user-activity-stats.js"></@script>
<@link rel="stylesheet" type="text/css" href="${page.url.context}/res/alfea/components/activity-stats/user-activity-stats.css" />
